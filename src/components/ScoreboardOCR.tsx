...
const ScoreboardOCR: Component = () => {
  ...
  const processImage = async () => {
    try {
      ...
      setProgress(20);
      const preprocessed = await preprocessImageForOCR(hardcodedImagePath);
  ...
  return (
    <div style={{ padding: '20px', 'font-family': 'Arial, sans-serif', 'max-width': '1400px', margin: '0 auto' }}>
      <h1 style={{ color: '#1976d2' }}>Overwatch Scoreboard Tracker POC</h1>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <h2 style={{ 'margin-top': '0', color: '#424242' }}>Original Image</h2>
          <img 
        ...
        <Show when={preprocessedImage()}>
          <div style={{ 
            ...
            <h2 style={{ 'margin-top': '0', color: '#424242' }}>Preprocessed (Grayscale + Contrast)</h2>
            <img 
            ...
            <p style={{ 'font-size': '13px', color: '#666', 'margin-top': '10px' }}>
              Image converted to grayscale and contrast enhanced for better OCR accuracy
            </p>
          </div>
        </Show>
      </div>
      ...
      <Show when={ocrText()}>
        <div style={{ 
          ...
          <h2 style={{ 'margin-top': '0', color: '#424242' }}>Raw OCR Text Output</h2>
          <pre style={{ 
      ...
      <Show when={Object.keys(extractedStats()).length > 0}>
        <div style={{
          ...
          <h2 style={{ 'margin-top': '0', color: '#2e7d32' }}>Extracted Game Stats (JSON)</h2>
          <pre style={{ 
            'background-color': '#fff', 
            padding: '20px',
            'border-radius': '4px',
          ...
          <p style={{ 'font-size': '13px', color: '#2e7d32', 'margin-top': '15px', 'margin-bottom': '0' }}>
            ✓ Successfully parsed {Object.keys(extractedStats()).length} data fields from the scoreboard
          </p>
        </div>
      </Show>
    </div>
