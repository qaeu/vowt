...
export function handleFileUpload(file: File, callback: (imageData: string) => void) {
 ...
 */
export function saveGameRecord(players: PlayerStats[], matchInfo: MatchInfo): string {
	const now = new Date();
