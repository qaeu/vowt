...
describe('RecordFieldInput', () => {
	...
	describe('Rendering', () => {
		it('should render an input element with correct id', () => {
			...
			const input = container.querySelector('input[id="test-field"]') as HTMLInputElement;
	...
	describe('Integration', () => {
		it('should work correctly with multiple fields', () => {
			...
			const field1 = document.querySelector('input[id="field-1"]') as HTMLInputElement;
			const field2 = document.querySelector('input[id="field-2"]') as HTMLInputElement;
